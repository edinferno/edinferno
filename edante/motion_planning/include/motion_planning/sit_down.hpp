...
#include <motion_planning_msgs/SitDownAction.h>
...
class SitDownAction {
 protected:
  ...
  actionlib::SimpleActionServer<motion_planning_msgs::SitDownAction> as_;
  std::string action_name_;
  motion_planning_msgs::SitDownFeedback feedback_;
  motion_planning_msgs::SitDownResult result_;

 public:
  SitDownAction(ros::NodeHandle nh, std::string name);
